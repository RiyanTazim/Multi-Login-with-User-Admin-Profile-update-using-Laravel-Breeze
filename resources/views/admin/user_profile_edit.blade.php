                ...
                <div class="card rounded">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <img class="wd-100 rounded-circle" src="{{(!empty($user->photo)) ? url('upload/user_images/'.$user->photo) : url('upload/no_image.jpg')}}" alt="profile">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="POST" action="{{route('user.profile.update', $user->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Photo</label>
                                    <img id="showImage" class="wd-80 rounded-circle" src="{{(!empty($user->photo)) ? url('upload/user_images/'.$user->photo) : url('/upload/no_image.jpg')}}" alt="profile">
                                </div>
